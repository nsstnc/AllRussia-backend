...
import io
import pytest
from app import app, verifyExt, create_jwt_token
...
class TestApp(unittest.TestCase):
    ...
    @patch('app.database.get_data_admin_panel')
    @patch('app.database.get_model_columns')
    @patch('app.get_jwt')
    ...
    @patch('app.jwt_required')
    @patch('app.database.get_record_by_id')
    ...
    @patch('app.jwt_required')
    @patch('app.database.update_record')
    @patch('app.database.get_record_by_id')
    ...
    @patch('app.jwt_required')
    @patch('app.database.get_next_id')
    @patch('app.database.insert_data')
    ...
    def test_upload_image(self, mock_path, mock_jwt_required):
        ...
        with patch('app.verifyExt', return_value=True), \
    ...
    def test_create_jwt_token(self):
        ...
        with patch('app.create_access_token', return_value='test_token') as mock_create_token, \
             patch('app.set_access_cookies') as mock_set_cookies:
